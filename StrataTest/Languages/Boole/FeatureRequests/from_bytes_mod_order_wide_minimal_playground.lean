/-
  Adapted from Strata/StrataTest/Languages/Boole/from_bytes_mod_order_wide_minimal.lean
-/
...
-- Generic array definition gives: Expected bitvector type, got: Strata.BooleDDM.BooleType.tvar { start := { byteIdx := 2266 }, stop := { byteIdx := 2267 } } "A"
-- 9 timeout VCs
#eval Strata.Boole.verify "cvc5" from_bytes_mod_order_wide_minimal_program (options := .quiet)

-- 25 goals, grind closes 16, leaves 9 unsolved
